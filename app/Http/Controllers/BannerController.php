...
class BannerController extends SuperAdminController
{
    /**
    ...
    public function edit()
    {
        ...
        return view('backend.edit_banner',compact('banner'));
    }
    ...
    public function update(Request $request)
    {
        ...
        $find_banner = \App\Banner::findOrFail($banner->banner_id) ;
    ...
    public function banner_logo(){
        return view('backend.banner.banner_logo');
    }

    public function store_banner_logo(Request $request)
    {
        $banner_logo = new \App\BannerLogo ;
    ...
    {
        $banner_image = new \App\BannerImage ;
