...
class TailorTeamController extends SuperAdminController
{
    /**
    ...
    {
        $this->AdminCheckAuth();
        return view('backend.tailor.team');
    }
    ...
    {
        return view('backend.tailor.team.add_member');
    }
