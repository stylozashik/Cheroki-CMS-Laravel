...
class TailorBookingController extends TailorSuperAdminController
{
    /**
    ...
    {
        $this->AdminCheckAuth();
        $booking_data = DB::table('tailor_bookings')->get();
        return view('backend.tailor.booking',compact('booking_data'));
    }
    ...
    {
        $booking = DB::table('tailor_bookings')
                            ->select('tailor_bookings.*')
                            ->where('booking_id','=',$booking_id)
                            ->first();
        return view('backend.tailor.booking.booking_details',compact('booking'));
    }
    ...
    public function edit($booking_id)
    {
        $booking = DB::table('tailor_bookings')
                            ...
                            ->where('booking_id','=',$booking_id)
                            ->first();
        return view('backend.tailor.booking.booking_edit',compact('booking'));
    }
    ...
    {
        $find_booking = \App\TailorBooking::findOrFail($booking_id);
        ...
        $find_booking->save();
        return redirect('/dashboard/tailor/booking');
    }
