...
class TailorOurWorksController extends SuperAdminController
{
    /**
    ...
    {
        $this->AdminCheckAuth();
        return view('backend.tailor.our_works');
    }
    ...
    {
        return view('backend.tailor.our_works.add_works');
    }
