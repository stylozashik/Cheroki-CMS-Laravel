...
<form role="form" action="{{ url('dashboard/tailor/our-works/store') }}" method="post" enctype="multipart/form-data">
    @csrf
    <div class="card-body">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="our_works_title" placeholder="CUT STYLE 1">
        </div>
    </div>
    <!-- /.card-body -->
