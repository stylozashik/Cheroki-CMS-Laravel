    ...
    @foreach ($booking_data as $booking)
        <tbody>
            <tr>
                ...
                <td>
                    <a class="btn btn-success" href="/dashboard/tailor/booking/{{ $booking->booking_id }}"> 
                        <i class="fas fa-eye"></i>
                    </a>
                    <a class="btn btn-warning" href="/dashboard/tailor/booking/{{ $booking->booking_id }}/edit"> 
                        <i class="fas fa-edit"></i>
                    </a>
                    
                </td>
                <td>
                    <form method="POST" action="/dashboard/tailor/booking/{{ $booking->booking_id }}/delete">
                        {{ method_field('DELETE') }}
                        @csrf
