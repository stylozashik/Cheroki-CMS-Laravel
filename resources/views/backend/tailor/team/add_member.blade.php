...
<form role="form" action="{{ url('dashboard/tailor/team/store') }}" method="post" enctype="multipart/form-data">
    @csrf
    <div class="card-body">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" name="designation" placeholder="Shirt SPECIALIST">
      </div>
      <div class="form-group">
