...
<form role="form" action="{{ url('dashboard/tailor/banner/store') }}" method="post" enctype="multipart/form-data">
    @csrf
    <div class="card-body">
      <div class="form-group">
        <label for="logo_title">Tailor Name</label>
        <input type="text" class="form-control" name="logo_title" placeholder="Cheroki The Tailor">
      </div>
      <div class="form-group">
